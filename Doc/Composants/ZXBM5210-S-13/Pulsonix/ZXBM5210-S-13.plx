...
(library Library_1
	...
	(compDef "ZXBM5210-S-13" (originalName "ZXBM5210-S-13") (compHeader (numPins 8) (numParts 1) (refDesPrefix M)
		...
		(compPin "2" (pinName "VM") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "3" (pinName "VDD") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "4" (pinName "FWD") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "8" (pinName "GND") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "7" (pinName "OUT2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Output))
		(compPin "6" (pinName "VREF") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "5" (pinName "REV") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Input))
		...
		(attr "<Hyperlink>" "https://rs.componentsearchengine.com/Datasheets/1/ZXBM5210-S-13.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ZXBM5210-S-13.stp")
