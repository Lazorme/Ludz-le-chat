...
(library Library_1
	...
	(symbolDef "ZXBM5210-S-13" (originalName "ZXBM5210-S-13")
	...
	(compDef "ZXBM5210-S-13" (originalName "ZXBM5210-S-13") (compHeader (numPins 8) (numParts 1) (refDesPrefix M)
		)
		(compPin "1" (pinName "OUT1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "VM") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "VDD") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "FWD") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "GND") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "OUT2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "VREF") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "REV") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ZXBM5210-S-13"))
		...
		(attr "Mouser Part Number" "621-ZXBM5210-S-13")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/ZXBM5210-S-13?qs=98WN%2FnWUQiQlr91Z1%2FDTeg%3D%3D")
		(attr "Manufacturer_Name" "Diodes Inc.")
		(attr "Manufacturer_Part_Number" "ZXBM5210-S-13")
		(attr "Description" "DiodesZetex ZXBM5210-S-13, DC Motor Driver")
		(attr "Datasheet Link" "https://rs.componentsearchengine.com/Datasheets/1/ZXBM5210-S-13.pdf")
		(attr "Height" "1.75 mm")
	)
